...
<div class="container-fluid my-3">
	...
	<form action="" method="post" enctype="multipart/form-data"></form>
		<div class="form-outline mb-3">
			...
			placeholder="enter your admin name"autocomplete="off" 
			required="required" name="admin_username"/>
		</div>
		<!--email feild-->
		<div class="form-outline mb-3">
		...
		<div class="form-outline mb-3">
			...
			<input type="file" id="admin_image" class="form-control" 
			placeholder="enter your Email"autocomplete="off" 
			required="required" name="admin_image"/>
		</div>
		...
		<div class="form-outline mb-3">
			<label for="conf_admin_password " class="form-label">onfirm password </label>
			<input type="password" id="conf_admin_password " class="form-control" 
			placeholder="confirm password " autocomplete="off" 
			required="required" name="conf_admin_password "/>
		</div>
		...
		<div class="form-outline mb-3">
			...
			<input type="text" id="admin_mobile" class="form-control" 
			placeholder="enter your Mobile number" autocomplete="off" 
			required="required" name="admin_mobile"/>
		</div>

		<div class="mt-4 pt-2">
			<input type="submit" value="Register" class="bg-dark text-light py-2 px-3 border-0"
			 border-0 name="admin_register" >
			<p class="small fw-bold mt-2 pt-1 mb-0"> Already have an account?<a href="admin_login.php" class="text-danger"> 
			Login </a></p>
		</div>
</form>
		</div>
